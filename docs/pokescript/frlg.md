# PokeScript Description for FireRed and LeafGreen
...
### checksound (0x30)
__Description__: Call before `cry <pkmn> 0`  
__Usage__: `checksound `  
...
### cry (0xA1)
__Description__: Plays a Pokemon cry  
__Usage__: `cry <arg0> <arg1> `  
__Argments__:  
    `word` `<arg0>`: Species sound to hear  
    `word` `<arg1>`: Seems to be padding. 0 is sufficient  
...
__Argments__:  
    `word` `<arg0>`: Weather type to change to.  
